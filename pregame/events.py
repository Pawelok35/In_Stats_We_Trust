...
class PregameEventType(_StrEnum):
    ...
    WAGER_EXECUTION_RECORDED = "WAGER_EXECUTION_RECORDED"
    WAGER_EXECUTION_SETTLED = "WAGER_EXECUTION_SETTLED"
    WAGER_EXECUTION_CLV_CALCULATED = "WAGER_EXECUTION_CLV_CALCULATED"
    CLOSING_QUOTE_LINKED = "CLOSING_QUOTE_LINKED"
    CLOSING_QUOTE_CAPTURED = "CLOSING_QUOTE_CAPTURED"
    AUTHORITATIVE_GAME_RESULT_RECORDED = "AUTHORITATIVE_GAME_RESULT_RECORDED"
