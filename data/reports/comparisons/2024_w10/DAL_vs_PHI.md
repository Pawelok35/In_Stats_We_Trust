...
| --- | ---: | ---: | ---: | ---: |
| EPA Offense | 35% | -0.487 | -0.022 | -0.465 |
| EPA Defense | 20% | -0.022 | -0.487 | +0.465 |
| Success Rate Offense | 25% | 44.0% | 47.7% | -3.7 pp |
| Tempo | 20% | 0.027 | 0.105 | -0.078 |

## PowerScore Breakdown (7 Metrics)

| Component | Weight | DAL | PHI | Delta |
| --- | ---: | ---: | ---: | ---: |
| EPA Offense | 25% | -0.487 | -0.022 | -0.465 |
| EPA Defense | 20% | -0.022 | -0.487 | +0.465 |
| Success Rate Offense | 15% | 44.0% | 47.7% | -3.7 pp |
| Turnover Margin | 10% | -3.000 | 3.000 | -6.000 |
| Tempo | 10% | 0.027 | 0.105 | -0.078 |
| Red Zone TD Rate (Off) | 10% | 0.0% | 20.0% | -20.0 pp |
| Pressure Rate (Def) | 10% | 17.9% | 9.4% | +8.5 pp |

## PowerScore Summary

**Model (4 metrics):**
PHI edge: +0.095 (DAL -0.059 vs PHI +0.035)
**7 metrics version:**
...
| --- | ---: | ---: | ---: | ---: | ---: | --- |
| DAL | 42.7% | 43.3% | -0.6% | 12.5% | 67.4% | Balanced |
| PHI | 32.6% | 43.3% | -10.7% | 42.9% | 50.0% | Run heavy |
...
| --- | ---: | ---: | ---: |
| DAL | -1.0 pp | -5.8 pp | -16.0 pp |
| PHI | +2.7 pp | +4.2 pp | -1.5 pp |

### Red Zone TD Rate

| Team | Season-to-date | Last 5 | Last 3 |
| --- | ---: | ---: | ---: |
| DAL | +3.8 pp | +2.1 pp | -0.1 pp |
| PHI | -7.3 pp | -4.7 pp | -2.7 pp |

### Pass Protection vs Pressure

| Team | Season-to-date | Last 5 | Last 3 |
| --- | ---: | ---: | ---: |
| DAL | +2.1 pp | +5.0 pp | +3.7 pp |
| PHI | -2.4 pp | -3.6 pp | -3.5 pp |

### Explosive Plays

| Team | Season-to-date | Last 5 | Last 3 |
| --- | ---: | ---: | ---: |
| DAL | +0.5 pp | +1.6 pp | +3.9 pp |
| PHI | +0.1 pp | +0.3 pp | -1.1 pp |
...
| Team | Season-to-date | Last 5 | Last 3 |
| --- | ---: | ---: | ---: |
| DAL | +2.6 pp | +2.9 pp | +6.7 pp |
| PHI | +0.1 pp | +1.2 pp | -1.4 pp |

### Pass Success Edge

| Team | Season-to-date | Last 5 | Last 3 |
| --- | ---: | ---: | ---: |
| DAL | +2.5 pp | +6.2 pp | +1.2 pp |
| PHI | +0.7 pp | -2.0 pp | -2.3 pp |
...
| Off EPA PHI | -0.012 | 0.311 | 0.011 | + improving |
| Def EPA DAL | 0.297 | 0.107 | 0.018 | + improving |
| Def EPA PHI | -0.069 | -0.017 | -0.069 | = stable |
| Off SR DAL | 43.5% | 46.9% | 43.6% | = stable |
| Off SR PHI | 45.0% | 53.9% | 42.7% | - declining |
| Def SR DAL | 50.0% | 51.8% | 44.0% | + improving |
| Def SR PHI | 42.1% | 45.1% | 41.8% | = stable |
| Tempo DAL | 7.727 | 6.750 | 8.545 | + improving |
| Tempo PHI | 8.000 | 9.500 | 7.385 | - declining |
...
| ---: | --- | --- | --- | ---: | ---: | ---: | ---: |
| 6 | DET (H) | 9-43 | DET | 0.827 | -0.274 | 43.5% | -3.098 |
| 5 | PIT (A) | 20-14 | DAL | 0.782 | 0.097 | 49.5% | 0.677 |
| 3 | BAL (H) | 25-26 | BAL | 0.742 | 0.063 | 41.2% | -0.061 |

**PHI analogs vs DAL profile**

| Week | Opponent | Score | Winner | Similarity | EPA Off | Success Rate | PPD Diff |
| ---: | --- | --- | --- | ---: | ---: | ---: | ---: |
| 9 | JAX (H) | 28-18 | PHI | 0.928 | 0.011 | 42.7% | 0.737 |
| 7 | NYG (A) | 28-3 | PHI | 0.787 | 0.132 | 44.6% | 1.923 |
| 2 | ATL (H) | 21-22 | ATL | 0.721 | 0.089 | 47.7% | -0.111 |

## Core EPA Offense Form (up to Week 9)

| Team | Season-to-date | Last 5 | Last 3 |
|------|---------------:|-------:|-------:|
| DAL | -0.016 | -0.017 | -0.096 |
| PHI | 0.063 | 0.082 | 0.151 |

## Core EPA Defense Form (up to Week 9)

| Team | Season-to-date | Last 5 | Last 3 |
|------|---------------:|-------:|-------:|
| DAL | 0.085 | 0.094 | 0.141 |
| PHI | -0.019 | -0.044 | -0.113 |
...
| Team | Season-to-date | Last 5 | Last 3 |
|------|---------------:|-------:|-------:|
| DAL | -0.637 | -0.630 | -1.289 |
| PHI | 0.721 | 0.992 | 1.661 |

## Yards per Play Differential Form (up to Week 9)

| Team | Season-to-date | Last 5 | Last 3 |
|------|---------------:|-------:|-------:|
| DAL | -0.609 | -0.493 | -1.590 |
| PHI | 0.750 | 1.031 | 1.749 |

## Turnover Margin Form (up to Week 9)

| Team | Season-to-date | Last 5 | Last 3 |
|------|---------------:|-------:|-------:|
| DAL | -0.875 | -1.400 | -2.000 |
| PHI | -0.250 | 0.400 | 0.667 |
...
| Team | Season-to-date | Last 5 | Last 3 |
|------|---------------:|-------:|-------:|
| DAL | 8.068 | 8.271 | 7.674 |
| PHI | 8.133 | 7.694 | 7.756 |
