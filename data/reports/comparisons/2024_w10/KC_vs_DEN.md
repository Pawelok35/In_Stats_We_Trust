...
| --- | ---: | ---: | ---: | ---: |
| EPA Offense | 35% | 0.019 | -0.013 | +0.032 |
| EPA Defense | 20% | -0.013 | 0.019 | -0.032 |
| Success Rate Offense | 25% | 42.0% | 42.7% | -0.7 pp |
| Tempo | 20% | 0.086 | 0.067 | +0.020 |

## PowerScore Breakdown (7 Metrics)

| Component | Weight | KC | DEN | Delta |
| --- | ---: | ---: | ---: | ---: |
| EPA Offense | 25% | 0.019 | -0.013 | +0.032 |
| EPA Defense | 20% | -0.013 | 0.019 | -0.032 |
| Success Rate Offense | 15% | 42.0% | 42.7% | -0.7 pp |
| Turnover Margin | 10% | 0.000 | 0.000 | +0.000 |
| Tempo | 10% | 0.086 | 0.067 | +0.020 |
| Red Zone TD Rate (Off) | 10% | 4.8% | 11.1% | -6.3 pp |
| Pressure Rate (Def) | 10% | 6.2% | 8.7% | -2.4 pp |

## PowerScore Summary

**Model (4 metrics):**
KC edge: +0.007 (KC +0.126 vs DEN +0.119)
**7 metrics version:**
...
| --- | ---: | ---: | ---: | ---: | ---: | --- |
| KC | 56.8% | 43.3% | 13.5% | 41.3% | 42.9% | Pass heavy |
| DEN | 42.7% | 43.3% | -0.6% | 53.1% | 34.9% | Balanced |
...
| --- | ---: | ---: | ---: |
| KC | +15.8 pp | +19.7 pp | +34.7 pp |
| DEN | +0.2 pp | +7.1 pp | +18.2 pp |

### Red Zone TD Rate

| Team | Season-to-date | Last 5 | Last 3 |
| --- | ---: | ---: | ---: |
| KC | -0.4 pp | -3.4 pp | -4.3 pp |
| DEN | +2.0 pp | +4.2 pp | -4.3 pp |

### Pass Protection vs Pressure

| Team | Season-to-date | Last 5 | Last 3 |
| --- | ---: | ---: | ---: |
| KC | +3.6 pp | +1.5 pp | +1.9 pp |
| DEN | +1.7 pp | +0.6 pp | +2.7 pp |

### Explosive Plays

| Team | Season-to-date | Last 5 | Last 3 |
| --- | ---: | ---: | ---: |
| KC | +0.7 pp | -0.2 pp | -0.7 pp |
| DEN | +2.7 pp | +6.0 pp | +4.6 pp |
...
| Team | Season-to-date | Last 5 | Last 3 |
| --- | ---: | ---: | ---: |
| KC | +7.2 pp | +3.4 pp | +3.0 pp |
| DEN | +7.4 pp | +10.9 pp | +2.5 pp |

### Pass Success Edge

| Team | Season-to-date | Last 5 | Last 3 |
| --- | ---: | ---: | ---: |
| KC | +7.8 pp | +8.4 pp | +5.0 pp |
| DEN | -10.9 pp | -4.9 pp | -8.8 pp |
...
| --- | --- | --- | --- | --- |
| Off EPA KC | 0.052 | 0.071 | 0.140 | + improving |
| Off EPA DEN | 0.064 | 0.059 | -0.118 | - declining |
| Def EPA KC | -0.112 | -0.042 | 0.133 | - declining |
| Def EPA DEN | -0.289 | -0.123 | 0.333 | - declining |
| Off SR KC | 54.1% | 52.3% | 53.5% | = stable |
| Off SR DEN | 53.7% | 47.1% | 36.0% | - declining |
| Def SR KC | 49.3% | 50.0% | 44.4% | + improving |
| Def SR DEN | 40.9% | 44.9% | 58.9% | - declining |
| Tempo KC | 7.727 | 9.556 | 8.417 | + improving |
| Tempo DEN | 6.833 | 7.250 | 8.600 | + improving |
...
| ---: | --- | --- | --- | ---: | ---: | ---: | ---: |
| 4 | LAC (A) | 17-11 | KC | 0.920 | -0.103 | 46.1% | 0.545 |
| 5 | NO (H) | 26-13 | KC | 0.803 | 0.093 | 56.1% | 1.300 |
| 8 | LV (A) | 27-20 | KC | 0.734 | 0.071 | 52.3% | 0.778 |

**DEN analogs vs KC profile**

| Week | Opponent | Score | Winner | Similarity | EPA Off | Success Rate | PPD Diff |
| ---: | --- | --- | --- | ---: | ---: | ---: | ---: |
| 9 | BAL (A) | 10-41 | BAL | 0.712 | -0.118 | 36.0% | -3.100 |
| 3 | TB (A) | 26-6 | DEN | 0.684 | 0.089 | 56.8% | 1.964 |
| 2 | PIT (H) | 6-14 | PIT | 0.663 | -0.118 | 44.2% | -0.682 |

## Core EPA Offense Form (up to Week 9)

| Team | Season-to-date | Last 5 | Last 3 |
|------|---------------:|-------:|-------:|
| DEN | -0.045 | -0.002 | 0.002 |
| KC | 0.057 | 0.051 | 0.088 |

## Core EPA Defense Form (up to Week 9)

| Team | Season-to-date | Last 5 | Last 3 |
|------|---------------:|-------:|-------:|
| DEN | -0.079 | -0.033 | -0.026 |
| KC | -0.032 | -0.066 | -0.007 |
...
| Team | Season-to-date | Last 5 | Last 3 |
|------|---------------:|-------:|-------:|
| DEN | 0.045 | 0.041 | -0.037 |
| KC | 0.495 | 0.642 | 0.469 |

## Yards per Play Differential Form (up to Week 9)

| Team | Season-to-date | Last 5 | Last 3 |
|------|---------------:|-------:|-------:|
| DEN | 0.210 | 0.233 | 0.302 |
| KC | 0.385 | 0.649 | 0.132 |

## Turnover Margin Form (up to Week 9)

| Team | Season-to-date | Last 5 | Last 3 |
|------|---------------:|-------:|-------:|
| DEN | -0.333 | 0.200 | 0.000 |
| KC | -0.500 | -0.400 | 0.000 |
...
| Team | Season-to-date | Last 5 | Last 3 |
|------|---------------:|-------:|-------:|
| DEN | 7.004 | 7.280 | 7.561 |
| KC | 8.164 | 8.482 | 8.566 |
