...
| --- | ---: | ---: | ---: |
| LV | -10.9 pp | -3.2 pp | -8.6 pp |
| DAL | -4.7 pp | -9.7 pp | -7.5 pp |

### Red Zone TD Rate

| Team | Season-to-date | Last 5 | Last 3 |
| --- | ---: | ---: | ---: |
| LV | -6.0 pp | -7.9 pp | -10.0 pp |
| DAL | +2.8 pp | +0.0 pp | -0.4 pp |

### Pass Protection vs Pressure

| Team | Season-to-date | Last 5 | Last 3 |
| --- | ---: | ---: | ---: |
| LV | -2.2 pp | +1.2 pp | +1.1 pp |
| DAL | +1.3 pp | +0.2 pp | +0.5 pp |

### Explosive Plays

| Team | Season-to-date | Last 5 | Last 3 |
| --- | ---: | ---: | ---: |
| LV | -2.9 pp | -5.1 pp | -7.9 pp |
| DAL | -0.2 pp | -0.8 pp | -1.0 pp |
...
| Team | Season-to-date | Last 5 | Last 3 |
| --- | ---: | ---: | ---: |
| LV | -8.1 pp | -8.4 pp | -10.8 pp |
| DAL | +2.9 pp | +2.1 pp | +3.6 pp |

### Pass Success Edge

| Team | Season-to-date | Last 5 | Last 3 |
| --- | ---: | ---: | ---: |
| LV | -4.3 pp | -0.9 pp | -6.1 pp |
| DAL | -1.7 pp | -3.0 pp | -2.1 pp |
...
| Window | LV | DAL |
| --- | ---: | ---: |
| Season-to-date | 0.135 | 0.225 |
| Last 5 games | 0.136 | 0.210 |
| Last 3 games | 0.142 | 0.196 |
...
| Off EPA DAL | 0.177 | 0.190 | -0.122 | - declining |
| Def EPA LV | -0.216 | 0.194 | 0.156 | - declining |
| Def EPA DAL | 0.153 | -0.106 | 0.053 | + improving |
| Off SR LV | 43.6% | 33.3% | 55.7% | + improving |
| Off SR DAL | 45.2% | 46.5% | 46.2% | + improving |
| Def SR LV | 40.8% | 50.0% | 54.6% | - declining |
| Def SR DAL | 56.5% | 47.2% | 50.0% | + improving |
| Tempo LV | 7.091 | 4.800 | 7.900 | + improving |
| Tempo DAL | 8.111 | 6.615 | 8.000 | - declining |
...
| Team | Season-to-date | Last 5 | Last 3 |
|------|---------------:|-------:|-------:|
| DAL | 0.118 | 0.113 | 0.044 |
| LV | -0.103 | -0.126 | -0.078 |

## Core EPA Defense Form (up to Week 10)

| Team | Season-to-date | Last 5 | Last 3 |
|------|---------------:|-------:|-------:|
| DAL | 0.140 | 0.091 | 0.093 |
| LV | 0.049 | 0.061 | 0.045 |
...
| Team | Season-to-date | Last 5 | Last 3 |
|------|---------------:|-------:|-------:|
| DAL | -0.343 | -0.097 | -0.598 |
| LV | -0.919 | -1.368 | -0.961 |

## Yards per Play Differential Form (up to Week 10)

| Team | Season-to-date | Last 5 | Last 3 |
|------|---------------:|-------:|-------:|
| DAL | -0.266 | -0.099 | -0.282 |
| LV | -0.296 | -0.129 | -0.765 |

## Turnover Margin Form (up to Week 10)

| Team | Season-to-date | Last 5 | Last 3 |
|------|---------------:|-------:|-------:|
| DAL | -0.444 | 0.000 | -0.667 |
| LV | -0.625 | -0.800 | 0.333 |
...
| Team | Season-to-date | Last 5 | Last 3 |
|------|---------------:|-------:|-------:|
| DAL | 8.004 | 7.621 | 7.720 |
| LV | 7.107 | 6.980 | 6.597 |
