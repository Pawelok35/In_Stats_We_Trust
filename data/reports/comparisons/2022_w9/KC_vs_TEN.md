...
| Component | Weight | KC | TEN | Delta |
| --- | ---: | ---: | ---: | ---: |
| EPA Offense | 35% | -0.027 | -0.057 | +0.031 |
| EPA Defense | 20% | -0.057 | -0.027 | -0.031 |
| Success Rate Offense | 25% | 39.0% | 33.3% | +5.6 pp |
| Tempo | 20% | 0.085 | 0.087 | -0.002 |

## PowerScore Breakdown (7 Metrics)

| Component | Weight | KC | TEN | Delta |
| --- | ---: | ---: | ---: | ---: |
| EPA Offense | 25% | -0.027 | -0.057 | +0.031 |
| EPA Defense | 20% | -0.057 | -0.027 | -0.031 |
| Success Rate Offense | 15% | 39.0% | 33.3% | +5.6 pp |
| Turnover Margin | 10% | -1.000 | 1.000 | -2.000 |
| Tempo | 10% | 0.085 | 0.087 | -0.002 |
| Red Zone TD Rate (Off) | 10% | 8.3% | 22.2% | -13.9 pp |
| Pressure Rate (Def) | 10% | 15.0% | 5.6% | +9.4 pp |

## PowerScore Summary

**Model (4 metrics):**
KC edge: +0.018 (KC +0.094 vs TEN +0.075)
**7 metrics version:**
...
| --- | ---: | ---: | ---: | ---: | ---: | --- |
| KC | 61.0% | 43.8% | 17.3% | 45.8% | 28.3% | Pass heavy |
| TEN | 29.0% | 43.8% | -14.8% | 20.0% | 38.8% | Run heavy |
...
| --- | ---: | ---: | ---: |
| KC | +19.3 pp | +19.7 pp | +20.8 pp |
| TEN | -2.2 pp | -3.9 pp | -8.2 pp |

### Red Zone TD Rate

| Team | Season-to-date | Last 5 | Last 3 |
| --- | ---: | ---: | ---: |
| KC | +3.0 pp | +3.4 pp | +3.0 pp |
| TEN | -4.6 pp | -1.7 pp | -6.1 pp |

### Pass Protection vs Pressure

| Team | Season-to-date | Last 5 | Last 3 |
| --- | ---: | ---: | ---: |
| KC | +3.5 pp | +1.2 pp | +2.2 pp |
| TEN | -5.3 pp | -5.8 pp | -9.4 pp |

### Explosive Plays

| Team | Season-to-date | Last 5 | Last 3 |
| --- | ---: | ---: | ---: |
| KC | +1.3 pp | +1.9 pp | +5.8 pp |
| TEN | -0.5 pp | -0.2 pp | -3.7 pp |
...
| Team | Season-to-date | Last 5 | Last 3 |
| --- | ---: | ---: | ---: |
| KC | +10.4 pp | +14.6 pp | +13.1 pp |
| TEN | -1.1 pp | +0.8 pp | -1.3 pp |

### Pass Success Edge

| Team | Season-to-date | Last 5 | Last 3 |
| --- | ---: | ---: | ---: |
| KC | +9.3 pp | +7.2 pp | +12.9 pp |
| TEN | -3.3 pp | -5.0 pp | -5.4 pp |
...
| --- | --- | --- | --- | --- |
| Off EPA KC | 0.213 | 0.155 | 0.372 | + improving |
| Off EPA TEN | 0.026 | 0.008 | -0.092 | - declining |
| Def EPA KC | 0.039 | 0.198 | 0.051 | - declining |
| Def EPA TEN | -0.110 | -0.052 | -0.222 | + improving |
| Off SR KC | 55.2% | 48.9% | 55.0% | = stable |
| Off SR TEN | 49.3% | 42.4% | 41.9% | - declining |
| Def SR KC | 51.9% | 43.0% | 44.3% | + improving |
| Def SR TEN | 35.8% | 36.2% | 43.6% | - declining |
| Tempo KC | 8.727 | 9.000 | 8.000 | - declining |
...
| ---: | --- | --- | --- | ---: | ---: | ---: | ---: |
| 7 | SF (A) | 42-21 | KC | 0.808 | 0.372 | 55.0% | 2.109 |
| 4 | TB (A) | 41-31 | KC | 0.718 | 0.213 | 55.2% | 0.909 |
| 3 | IND (A) | 17-18 | IND | 0.631 | -0.031 | 39.7% | -0.118 |

**TEN analogs vs KC profile**

| Week | Opponent | Score | Winner | Similarity | EPA Off | Success Rate | PPD Diff |
| ---: | --- | --- | --- | ---: | ---: | ---: | ---: |
| 1 | NYG (H) | 20-21 | NYG | 0.848 | 0.018 | 43.0% | -0.083 |
| 3 | LV (H) | 24-24 | TIE | 0.781 | 0.089 | 45.9% | -0.044 |
| 2 | BUF (A) | 7-32 | BUF | 0.730 | -0.275 | 37.3% | -2.280 |

## Core EPA Offense Form (up to Week 8)

| Team | Season-to-date | Last 5 | Last 3 |
|------|---------------:|-------:|-------:|
| KC | 0.167 | 0.149 | 0.188 |
| TEN | -0.042 | -0.007 | -0.050 |

## Core EPA Defense Form (up to Week 8)

| Team | Season-to-date | Last 5 | Last 3 |
|------|---------------:|-------:|-------:|
| KC | 0.058 | 0.074 | 0.111 |
| TEN | -0.039 | -0.103 | -0.167 |
...
| Team | Season-to-date | Last 5 | Last 3 |
|------|---------------:|-------:|-------:|
| KC | 0.625 | 0.464 | 0.496 |
| TEN | -0.098 | 0.343 | 0.407 |

## Yards per Play Differential Form (up to Week 8)

| Team | Season-to-date | Last 5 | Last 3 |
|------|---------------:|-------:|-------:|
| KC | 0.577 | 0.330 | 0.322 |
| TEN | -0.611 | -0.170 | -0.028 |

## Turnover Margin Form (up to Week 8)

| Team | Season-to-date | Last 5 | Last 3 |
|------|---------------:|-------:|-------:|
| KC | 0.571 | 0.800 | 0.667 |
| TEN | 1.143 | 1.400 | 1.333 |
...
| Team | Season-to-date | Last 5 | Last 3 |
|------|---------------:|-------:|-------:|
| KC | 8.052 | 8.345 | 8.400 |
| TEN | 7.027 | 7.040 | 6.967 |
