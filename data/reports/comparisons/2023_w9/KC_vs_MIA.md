...
| Component | Weight | KC | MIA | Delta |
| --- | ---: | ---: | ---: | ---: |
| EPA Offense | 35% | 0.023 | -0.065 | +0.088 |
| EPA Defense | 20% | -0.065 | 0.023 | -0.088 |
| Success Rate Offense | 25% | 45.3% | 45.0% | +0.3 pp |
| Tempo | 20% | 0.080 | 0.100 | -0.020 |

## PowerScore Breakdown (7 Metrics)

| Component | Weight | KC | MIA | Delta |
| --- | ---: | ---: | ---: | ---: |
| EPA Offense | 25% | 0.023 | -0.065 | +0.088 |
| EPA Defense | 20% | -0.065 | 0.023 | -0.088 |
| Success Rate Offense | 15% | 45.3% | 45.0% | +0.3 pp |
| Turnover Margin | 10% | 0.000 | 0.000 | +0.000 |
| Tempo | 10% | 0.080 | 0.100 | -0.020 |
| Red Zone TD Rate (Off) | 10% | 28.6% | 33.3% | -4.8 pp |
| Pressure Rate (Def) | 10% | 8.1% | 5.7% | +2.4 pp |

## PowerScore Summary

**Model (4 metrics):**
KC edge: +0.010 (KC +0.124 vs MIA +0.114)
**7 metrics version:**
...
| --- | ---: | ---: | ---: | ---: | ---: | --- |
| KC | 46.7% | 45.1% | 1.6% | 40.0% | 50.0% | Slight pass lean |
| MIA | 46.2% | 45.1% | 1.2% | 37.8% | 51.2% | Slight pass lean |
...
| --- | ---: | ---: | ---: |
| KC | +6.2 pp | +11.2 pp | +9.6 pp |
| MIA | +5.9 pp | -3.9 pp | +0.5 pp |

### Red Zone TD Rate

| Team | Season-to-date | Last 5 | Last 3 |
| --- | ---: | ---: | ---: |
| KC | -3.0 pp | -5.0 pp | -7.7 pp |
| MIA | -0.1 pp | -7.2 pp | -14.3 pp |

### Pass Protection vs Pressure

| Team | Season-to-date | Last 5 | Last 3 |
| --- | ---: | ---: | ---: |
| KC | +5.8 pp | +5.9 pp | +4.2 pp |
| MIA | +6.4 pp | +6.2 pp | +12.7 pp |

### Explosive Plays

| Team | Season-to-date | Last 5 | Last 3 |
| --- | ---: | ---: | ---: |
| KC | +2.3 pp | +1.1 pp | +1.6 pp |
| MIA | +8.0 pp | +5.7 pp | +3.8 pp |
...
| Team | Season-to-date | Last 5 | Last 3 |
| --- | ---: | ---: | ---: |
| KC | -3.5 pp | -2.4 pp | -3.9 pp |
| MIA | +5.4 pp | +2.1 pp | -2.2 pp |

### Pass Success Edge

| Team | Season-to-date | Last 5 | Last 3 |
| --- | ---: | ---: | ---: |
| KC | +2.5 pp | +5.0 pp | +12.2 pp |
| MIA | +18.4 pp | +14.7 pp | +15.3 pp |
...
| --- | --- | --- | --- | --- |
| Off EPA KC | -0.011 | 0.201 | -0.234 | - declining |
| Off EPA MIA | 0.164 | -0.132 | 0.025 | - declining |
| Def EPA KC | -0.205 | 0.040 | -0.015 | - declining |
| Def EPA MIA | -0.108 | 0.074 | -0.152 | + improving |
| Off SR KC | 49.4% | 47.0% | 38.9% | - declining |
| Off SR MIA | 48.8% | 42.4% | 43.5% | - declining |
| Def SR KC | 40.6% | 36.2% | 44.2% | - declining |
| Def SR MIA | 38.8% | 47.6% | 35.7% | + improving |
| Tempo KC | 7.727 | 7.545 | 6.545 | - declining |
| Tempo MIA | 7.000 | 7.333 | 8.364 | + improving |

## Matchup Analogs

**KC analogs vs MIA profile**

| Week | Opponent | Score | Winner | Similarity | EPA Off | Success Rate | PPD Diff |
| ---: | --- | --- | --- | ---: | ---: | ---: | ---: |
| 5 | MIN (A) | 27-20 | KC | 0.881 | 0.133 | 42.7% | 0.875 |
| 7 | LAC (H) | 31-17 | KC | 0.814 | 0.201 | 47.0% | 1.273 |
| 6 | DEN (H) | 19-9 | KC | 0.712 | -0.011 | 49.4% | 0.927 |

**MIA analogs vs KC profile**

| Week | Opponent | Score | Winner | Similarity | EPA Off | Success Rate | PPD Diff |
| ---: | --- | --- | --- | ---: | ---: | ---: | ---: |
| 4 | BUF (A) | 20-44 | BUF | 0.852 | -0.047 | 42.7% | -2.182 |
| 7 | PHI (A) | 11-28 | PHI | 0.836 | -0.132 | 42.4% | -1.878 |
| 1 | LAC (A) | 36-37 | LAC | 0.502 | 0.219 | 47.6% | -0.127 |

## Core EPA Offense Form (up to Week 8)

| Team | Season-to-date | Last 5 | Last 3 |
|------|---------------:|-------:|-------:|
| KC | 0.033 | 0.033 | -0.015 |
| MIA | 0.103 | 0.014 | 0.019 |

## Core EPA Defense Form (up to Week 8)

| Team | Season-to-date | Last 5 | Last 3 |
|------|---------------:|-------:|-------:|
| KC | -0.077 | -0.039 | -0.060 |
| MIA | 0.005 | 0.016 | -0.062 |
...
| Team | Season-to-date | Last 5 | Last 3 |
|------|---------------:|-------:|-------:|
| KC | 0.789 | 0.408 | 0.279 |
| MIA | 0.815 | 0.372 | 0.753 |

## Yards per Play Differential Form (up to Week 8)

| Team | Season-to-date | Last 5 | Last 3 |
|------|---------------:|-------:|-------:|
| KC | 0.966 | 0.878 | 1.275 |
| MIA | 1.655 | 1.230 | 0.720 |
...
| Team | Season-to-date | Last 5 | Last 3 |
|------|---------------:|-------:|-------:|
| KC | 7.941 | 7.941 | 7.273 |
| MIA | 7.160 | 7.267 | 7.566 |
