...
| Component | Weight | CIN | BUF | Delta |
| --- | ---: | ---: | ---: | ---: |
| EPA Offense | 35% | 0.087 | 0.031 | +0.057 |
| EPA Defense | 20% | 0.031 | 0.087 | -0.057 |
| Success Rate Offense | 25% | 44.7% | 50.0% | -5.3 pp |
| Tempo | 20% | 0.118 | 0.100 | +0.018 |

## PowerScore Breakdown (7 Metrics)

| Component | Weight | CIN | BUF | Delta |
| --- | ---: | ---: | ---: | ---: |
| EPA Offense | 25% | 0.087 | 0.031 | +0.057 |
| EPA Defense | 20% | 0.031 | 0.087 | -0.057 |
| Success Rate Offense | 15% | 44.7% | 50.0% | -5.3 pp |
| Turnover Margin | 10% | 2.000 | -2.000 | +4.000 |
| Tempo | 10% | 0.118 | 0.100 | +0.018 |
| Red Zone TD Rate (Off) | 10% | 13.3% | 22.2% | -8.9 pp |
| Pressure Rate (Def) | 10% | 2.5% | 2.1% | +0.4 pp |

## PowerScore Summary

**Model (4 metrics):**
BUF edge: +0.001 (CIN +0.172 vs BUF +0.173)
**7 metrics version:**
...
| --- | ---: | ---: | ---: | ---: | ---: | --- |
| CIN | 56.5% | 45.1% | 11.4% | 50.0% | 37.8% | Pass heavy |
| BUF | 57.1% | 45.1% | 12.1% | 52.5% | 46.7% | Pass heavy |
...
| --- | ---: | ---: | ---: |
| CIN | -2.0 pp | -7.1 pp | -3.3 pp |
| BUF | +6.0 pp | +5.6 pp | -1.0 pp |

### Red Zone TD Rate

| Team | Season-to-date | Last 5 | Last 3 |
| --- | ---: | ---: | ---: |
| CIN | -0.8 pp | +2.3 pp | +3.1 pp |
| BUF | +1.8 pp | +4.5 pp | -1.3 pp |

### Pass Protection vs Pressure

| Team | Season-to-date | Last 5 | Last 3 |
| --- | ---: | ---: | ---: |
| CIN | +5.6 pp | +4.9 pp | +4.4 pp |
| BUF | +2.7 pp | +4.0 pp | +0.3 pp |

### Explosive Plays

| Team | Season-to-date | Last 5 | Last 3 |
| --- | ---: | ---: | ---: |
| CIN | -5.7 pp | -4.9 pp | -1.4 pp |
| BUF | -1.8 pp | -2.2 pp | -3.8 pp |
...
| Team | Season-to-date | Last 5 | Last 3 |
| --- | ---: | ---: | ---: |
| CIN | -2.1 pp | +1.1 pp | +3.9 pp |
| BUF | +5.2 pp | +5.2 pp | +8.0 pp |

### Pass Success Edge

| Team | Season-to-date | Last 5 | Last 3 |
| --- | ---: | ---: | ---: |
| CIN | +0.5 pp | +1.9 pp | +7.5 pp |
| BUF | +6.3 pp | +9.5 pp | +5.3 pp |
...
| --- | --- | --- | --- | --- |
| Off EPA CIN | -0.007 | -0.026 | 0.210 | + improving |
| Off EPA BUF | 0.117 | -0.083 | 0.075 | - declining |
| Def EPA CIN | -0.276 | -0.055 | -0.025 | - declining |
| Def EPA BUF | 0.142 | -0.098 | 0.013 | + improving |
| Off SR CIN | 50.5% | 43.7% | 56.4% | + improving |
| Off SR BUF | 47.3% | 45.3% | 51.2% | + improving |
| Def SR CIN | 30.1% | 44.2% | 49.3% | - declining |
| Def SR BUF | 46.7% | 44.0% | 38.6% | + improving |
| Tempo CIN | 7.462 | 6.455 | 7.800 | + improving |
| Tempo BUF | 6.167 | 8.333 | 7.818 | + improving |

## Matchup Analogs

**CIN analogs vs BUF profile**

| Week | Opponent | Score | Winner | Similarity | EPA Off | Success Rate | PPD Diff |
| ---: | --- | --- | --- | ---: | ---: | ---: | ---: |
| 8 | SF (A) | 31-14 | CIN | 0.961 | 0.210 | 56.4% | 1.683 |
| 2 | BAL (H) | 18-29 | BAL | 0.874 | 0.036 | 47.2% | -1.417 |
| 6 | SEA (H) | 17-13 | CIN | 0.858 | -0.026 | 43.7% | 0.364 |

**BUF analogs vs CIN profile**

| Week | Opponent | Score | Winner | Similarity | EPA Off | Success Rate | PPD Diff |
| ---: | --- | --- | --- | ---: | ---: | ---: | ---: |
| 6 | NYG (H) | 14-8 | BUF | 0.796 | -0.083 | 45.3% | 0.656 |
| 2 | LV (H) | 38-10 | BUF | 0.794 | 0.260 | 57.6% | 3.111 |
| 1 | NYJ (A) | 22-15 | BUF | 0.698 | -0.114 | 46.4% | 0.667 |

## Core EPA Offense Form (up to Week 8)

| Team | Season-to-date | Last 5 | Last 3 |
|------|---------------:|-------:|-------:|
| BUF | 0.106 | 0.109 | 0.020 |
| CIN | -0.063 | -0.015 | 0.059 |

## Core EPA Defense Form (up to Week 8)

| Team | Season-to-date | Last 5 | Last 3 |
|------|---------------:|-------:|-------:|
| BUF | -0.060 | 0.017 | -0.003 |
| CIN | -0.047 | -0.062 | -0.119 |
...
| Team | Season-to-date | Last 5 | Last 3 |
|------|---------------:|-------:|-------:|
| BUF | 1.087 | 0.539 | 0.263 |
| CIN | -0.349 | 0.116 | 0.848 |

## Yards per Play Differential Form (up to Week 8)

| Team | Season-to-date | Last 5 | Last 3 |
|------|---------------:|-------:|-------:|
| BUF | 0.501 | 0.517 | 0.358 |
| CIN | -1.193 | -1.125 | -0.911 |

## Turnover Margin Form (up to Week 8)

| Team | Season-to-date | Last 5 | Last 3 |
|------|---------------:|-------:|-------:|
| BUF | 0.250 | -0.400 | -1.333 |
| CIN | 1.000 | 1.200 | 1.667 |
...
| Team | Season-to-date | Last 5 | Last 3 |
|------|---------------:|-------:|-------:|
| BUF | 7.813 | 7.457 | 8.317 |
| CIN | 7.277 | 7.348 | 7.239 |
