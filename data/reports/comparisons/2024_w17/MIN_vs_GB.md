...
| --- | ---: | ---: | ---: | ---: |
| EPA Offense | 35% | -0.027 | -0.033 | +0.007 |
| EPA Defense | 20% | -0.033 | -0.027 | -0.007 |
| Success Rate Offense | 25% | 50.0% | 50.6% | -0.6 pp |
| Tempo | 20% | 0.109 | 0.078 | +0.031 |

## PowerScore Breakdown (7 Metrics)

| Component | Weight | MIN | GB | Delta |
| --- | ---: | ---: | ---: | ---: |
| EPA Offense | 25% | -0.027 | -0.033 | +0.007 |
| EPA Defense | 20% | -0.033 | -0.027 | -0.007 |
| Success Rate Offense | 15% | 50.0% | 50.6% | -0.6 pp |
| Turnover Margin | 10% | 0.000 | 0.000 | +0.000 |
| Tempo | 10% | 0.109 | 0.078 | +0.031 |
| Red Zone TD Rate (Off) | 10% | 16.7% | 15.8% | +0.9 pp |
| Pressure Rate (Def) | 10% | 8.8% | 4.3% | +4.6 pp |

## PowerScore Summary

**Model (4 metrics):**
MIN edge: +0.006 (MIN +0.131 vs GB +0.125)
**7 metrics version:**
...
| --- | ---: | ---: | ---: | ---: | ---: | --- |
| MIN | 51.1% | 43.9% | 7.2% | 57.4% | 42.2% | Pass heavy |
| GB | 44.2% | 43.9% | 0.3% | 50.0% | 51.2% | Balanced |
...
| --- | ---: | ---: | ---: |
| MIN | +4.2 pp | +5.3 pp | +8.6 pp |
| GB | +1.9 pp | +6.2 pp | +4.1 pp |

### Red Zone TD Rate

| Team | Season-to-date | Last 5 | Last 3 |
| --- | ---: | ---: | ---: |
| MIN | +1.9 pp | +9.5 pp | +15.3 pp |
| GB | +3.8 pp | +5.2 pp | +5.4 pp |

### Pass Protection vs Pressure

| Team | Season-to-date | Last 5 | Last 3 |
| --- | ---: | ---: | ---: |
| MIN | -1.2 pp | -0.6 pp | +0.9 pp |
| GB | +3.6 pp | +1.4 pp | +3.6 pp |

### Explosive Plays

| Team | Season-to-date | Last 5 | Last 3 |
| --- | ---: | ---: | ---: |
| MIN | +1.2 pp | +3.3 pp | +3.2 pp |
| GB | +1.5 pp | +0.6 pp | -1.9 pp |
...
| Team | Season-to-date | Last 5 | Last 3 |
| --- | ---: | ---: | ---: |
| MIN | +0.7 pp | +9.9 pp | +3.0 pp |
| GB | +2.6 pp | +2.1 pp | +1.6 pp |

### Pass Success Edge

| Team | Season-to-date | Last 5 | Last 3 |
| --- | ---: | ---: | ---: |
| MIN | +1.6 pp | +8.6 pp | +11.8 pp |
| GB | +3.5 pp | +0.5 pp | -1.8 pp |
...
| --- | --- | --- | --- | --- |
| Off EPA MIN | 0.290 | 0.046 | 0.123 | - declining |
| Off EPA GB | 0.115 | 0.088 | 0.246 | + improving |
| Def EPA MIN | 0.000 | -0.169 | 0.038 | - declining |
| Def EPA GB | 0.076 | -0.191 | -0.268 | + improving |
| Off SR MIN | 51.9% | 52.6% | 50.0% | - declining |
| Off SR GB | 49.3% | 53.8% | 50.6% | + improving |
| Def SR MIN | 54.9% | 41.9% | 52.9% | + improving |
| Def SR GB | 53.7% | 42.9% | 35.7% | + improving |
| Tempo MIN | 7.364 | 9.500 | 6.462 | - declining |
| Tempo GB | 6.900 | 6.667 | 9.444 | + improving |
...
| ---: | --- | --- | --- | ---: | ---: | ---: | ---: |
| 4 | GB (A) | 31-29 | MIN | 1.000 | 0.001 | 49.4% | 0.133 |
| 7 | DET (H) | 23-34 | DET | 0.872 | 0.008 | 37.7% | -0.902 |
| 13 | ARI (H) | 23-22 | MIN | 0.583 | 0.015 | 60.3% | 0.100 |

**GB analogs vs MIN profile**

| Week | Opponent | Score | Winner | Similarity | EPA Off | Success Rate | PPD Diff |
| ---: | --- | --- | --- | ---: | ---: | ---: | ---: |
| 4 | MIN (H) | 29-31 | MIN | 1.000 | -0.073 | 46.2% | -0.133 |
| 1 | PHI (A) | 29-34 | PHI | 0.942 | 0.091 | 46.5% | -0.455 |
| 9 | DET (H) | 14-18 | DET | 0.842 | -0.056 | 47.5% | -0.444 |

## Core EPA Offense Form (up to Week 16)

| Team | Season-to-date | Last 5 | Last 3 |
|------|---------------:|-------:|-------:|
| GB | 0.099 | 0.175 | 0.150 |
| MIN | 0.046 | 0.123 | 0.153 |

## Core EPA Defense Form (up to Week 16)

| Team | Season-to-date | Last 5 | Last 3 |
|------|---------------:|-------:|-------:|
| GB | -0.045 | -0.116 | -0.128 |
| MIN | -0.090 | -0.013 | -0.044 |
...
| Team | Season-to-date | Last 5 | Last 3 |
|------|---------------:|-------:|-------:|
| GB | 0.815 | 1.751 | 1.648 |
| MIN | 0.567 | 0.741 | 1.147 |

## Yards per Play Differential Form (up to Week 16)

| Team | Season-to-date | Last 5 | Last 3 |
|------|---------------:|-------:|-------:|
| GB | 0.865 | 1.100 | 1.356 |
| MIN | 0.350 | 0.095 | -0.189 |

## Turnover Margin Form (up to Week 16)

| Team | Season-to-date | Last 5 | Last 3 |
|------|---------------:|-------:|-------:|
| GB | 0.667 | 1.000 | 1.000 |
| MIN | 0.667 | 0.800 | 1.667 |
...
| Team | Season-to-date | Last 5 | Last 3 |
|------|---------------:|-------:|-------:|
| GB | 7.510 | 7.606 | 7.670 |
| MIN | 7.094 | 7.282 | 7.775 |
