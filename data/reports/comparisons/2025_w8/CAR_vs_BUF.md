...
| PowerScore | 1.520 | 1.767 | -0.247 |
| PowerScore | 1.520 | 1.767 | -0.247 |
| Tempo | 7.091 | 7.900 | -0.809 |

## PowerScore Breakdown (Model)

| Component | Weight | CAR | BUF | Delta |
| --- | ---: | ---: | ---: | ---: |
| EPA Offense | 35% | -0.210 | 0.283 | -0.493 |
| EPA Defense | 20% | 0.283 | -0.210 | +0.493 |
| Success Rate Offense | 25% | 47.4% | 51.9% | -4.5 pp |
| Tempo | 20% | 0.090 | 0.127 | -0.037 |

## PowerScore Breakdown (7 Metrics)

| Component | Weight | CAR | BUF | Delta |
| --- | ---: | ---: | ---: | ---: |
| EPA Offense | 25% | -0.210 | 0.283 | -0.493 |
| EPA Defense | 20% | 0.283 | -0.210 | +0.493 |
| Success Rate Offense | 15% | 47.4% | 51.9% | -4.5 pp |
| Turnover Margin | 10% | -3.000 | 3.000 | -6.000 |
| Tempo | 10% | 0.090 | 0.127 | -0.037 |
| Red Zone TD Rate (Off) | 10% | 9.1% | 12.5% | -3.4 pp |
| Pressure Rate (Def) | 10% | 8.0% | 22.6% | -14.6 pp |

## PowerScore Summary

**Model (4 metrics):**
BUF edge: +0.092 (CAR +0.119 vs BUF +0.212)
**7 metrics version:**
...
| Metric | Value |
| --- | --- |
| Model Spread (CAR - BUF) | -4.6 pts (favours BUF) |
| Model Win% CAR | 31.8% |
| Model Win% BUF | 68.2% |
| SOS Differential (CAR-BUF) | -0.087 |
...
| Window | CAR | BUF |
| --- | ---: | ---: |
| Season-to-date | 1.554 | 1.641 |
| Last 5 games | 1.515 | 1.651 |
| Last 3 games | 1.599 | 1.676 |
