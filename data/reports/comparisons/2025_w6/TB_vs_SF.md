...
| --- | ---: | ---: | ---: | ---: |
| EPA Offense | 35% | 0.157 | 0.016 | +0.141 |
| EPA Defense | 20% | 0.016 | 0.157 | -0.141 |
| Success Rate Offense | 25% | 53.6% | 50.0% | +3.6 pp |
| Tempo | 20% | 0.159 | 0.091 | +0.069 |

## PowerScore Breakdown (7 Metrics)

| Component | Weight | TB | SF | Delta |
| --- | ---: | ---: | ---: | ---: |
| EPA Offense | 25% | 0.157 | 0.016 | +0.141 |
| EPA Defense | 20% | 0.016 | 0.157 | -0.141 |
| Success Rate Offense | 15% | 53.6% | 50.0% | +3.6 pp |
| Turnover Margin | 10% | 2.000 | -2.000 | +4.000 |
| Tempo | 10% | 0.159 | 0.091 | +0.069 |
| Red Zone TD Rate (Off) | 10% | 22.2% | 9.1% | +13.1 pp |
| Pressure Rate (Def) | 10% | 13.3% | 4.0% | +9.3 pp |

## PowerScore Summary

**Model (4 metrics):**
TB edge: +0.044 (TB +0.224 vs SF +0.180)
**7 metrics version:**
...
| Metric | Value |
| --- | --- |
| Model Spread (TB - SF) | -8.8 pts (favours SF) |
| Model Win% TB | 18.8% |
| Model Win% SF | 81.2% |
| SOS Differential (TB-SF) | -0.067 |
...
| Window | TB | SF |
| --- | ---: | ---: |
| Season-to-date | 1.561 | 1.628 |
| Last 5 games | 1.561 | 1.628 |
| Last 3 games | 1.538 | 1.684 |
