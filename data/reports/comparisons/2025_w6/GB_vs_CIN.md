...
| Component | Weight | GB | CIN | Delta |
| --- | ---: | ---: | ---: | ---: |
| EPA Offense | 35% | 0.216 | 0.096 | +0.120 |
| EPA Defense | 20% | 0.096 | 0.216 | -0.120 |
| Success Rate Offense | 25% | 58.7% | 53.1% | +5.6 pp |
| Tempo | 20% | 0.160 | 0.062 | +0.098 |

## PowerScore Breakdown (7 Metrics)

| Component | Weight | GB | CIN | Delta |
| --- | ---: | ---: | ---: | ---: |
| EPA Offense | 25% | 0.216 | 0.096 | +0.120 |
| EPA Defense | 20% | 0.096 | 0.216 | -0.120 |
| Success Rate Offense | 15% | 58.7% | 53.1% | +5.6 pp |
| Turnover Margin | 10% | -1.000 | 1.000 | -2.000 |
| Tempo | 10% | 0.160 | 0.062 | +0.098 |
| Red Zone TD Rate (Off) | 10% | 30.0% | 15.4% | +14.6 pp |
| Pressure Rate (Def) | 10% | 2.1% | 3.6% | -1.4 pp |

## PowerScore Summary

**Model (4 metrics):**
GB edge: +0.052 (GB +0.274 vs CIN +0.222)
**7 metrics version:**
...
| Metric | Value |
| --- | --- |
| Model Spread (GB - CIN) | +1.0 pts (favours GB) |
| Model Win% GB | 54.0% |
| Model Win% CIN | 46.0% |
| SOS Differential (GB-CIN) | +0.002 |
...
| Window | GB | CIN |
| --- | ---: | ---: |
| Season-to-date | 0.144 | 0.142 |
| Last 5 games | 0.144 | 0.142 |
| Last 3 games | 0.147 | 0.151 |
