...
| --- | ---: | ---: | ---: | ---: |
| EPA Offense | 35% | -0.250 | -0.087 | -0.163 |
| EPA Defense | 20% | -0.087 | -0.250 | +0.163 |
| Success Rate Offense | 25% | 36.6% | 46.5% | -9.9 pp |
| Tempo | 20% | 0.073 | 0.085 | -0.011 |

## PowerScore Breakdown (7 Metrics)

| Component | Weight | LV | LAC | Delta |
| --- | ---: | ---: | ---: | ---: |
| EPA Offense | 25% | -0.250 | -0.087 | -0.163 |
| EPA Defense | 20% | -0.087 | -0.250 | +0.163 |
| Success Rate Offense | 15% | 36.6% | 46.5% | -9.9 pp |
| Turnover Margin | 10% | -2.000 | 2.000 | -4.000 |
| Tempo | 10% | 0.073 | 0.085 | -0.011 |
...
**Model (4 metrics):**
LAC edge: +0.052 (LV +0.001 vs LAC +0.053)
**7 metrics version:**
...
| Metric | Value |
| --- | --- |
| Model Spread (LV - LAC) | +5.5 pts (favours LV) |
| Model Win% LV | 71.6% |
| Model Win% LAC | 28.4% |
| SOS Differential (LV-LAC) | -0.414 |
...
| --- | ---: | ---: | ---: | ---: | ---: | --- |
| LV | 56.1% | 44.7% | 11.4% | 23.9% | 52.8% | Pass heavy |
| LAC | 43.7% | 44.7% | -1.0% | 48.4% | 45.0% | Balanced |
...
| --- | ---: | ---: | ---: |
| LV | +4.5 pp | +4.5 pp | +4.5 pp |
| LAC | +25.0 pp | +25.0 pp | +25.0 pp |

### Red Zone TD Rate

| Team | Season-to-date | Last 5 | Last 3 |
| --- | ---: | ---: | ---: |
| LV | +11.7 pp | +11.7 pp | +11.7 pp |
| LAC | +3.2 pp | +3.2 pp | +3.2 pp |
...
| Team | Season-to-date | Last 5 | Last 3 |
| --- | ---: | ---: | ---: |
| LV | -15.6 pp | -15.6 pp | -15.6 pp |
| LAC | +9.8 pp | +9.8 pp | +9.8 pp |

### Pass Success Edge

| Team | Season-to-date | Last 5 | Last 3 |
| --- | ---: | ---: | ---: |
| LV | +13.4 pp | +13.4 pp | +13.4 pp |
...
| Window | LV | LAC |
| --- | ---: | ---: |
| Season-to-date | 1.763 | 2.177 |
| Last 5 games | 1.763 | 2.177 |
| Last 3 games | 1.763 | 2.177 |
...
| ---: | --- | --- | --- | ---: | ---: | ---: | ---: |
| 1 | NE (A) | 20-14 | LV | 0.229 | 0.081 | 44.4% | 0.485 |

**LAC analogs vs LV profile**

| Week | Opponent | Score | Winner | Similarity | EPA Off | Success Rate | PPD Diff |
| ---: | --- | --- | --- | ---: | ---: | ---: | ---: |
| 1 | KC (H) | 27-21 | LAC | 0.335 | 0.211 | 56.8% | 0.750 |

## Core EPA Offense Form (up to Week 1)

| Team | Season-to-date | Last 5 | Last 3 |
|------|---------------:|-------:|-------:|
| LAC | 0.211 | 0.211 | 0.211 |
| LV | 0.081 | 0.081 | 0.081 |
...
| Team | Season-to-date | Last 5 | Last 3 |
|------|---------------:|-------:|-------:|
| LAC | 0.750 | 0.750 | 0.750 |
| LV | 0.485 | 0.485 | 0.485 |

## Yards per Play Differential Form (up to Week 1)

| Team | Season-to-date | Last 5 | Last 3 |
|------|---------------:|-------:|-------:|
| LAC | 0.472 | 0.472 | 0.472 |
| LV | 1.110 | 1.110 | 1.110 |
...
| Team | Season-to-date | Last 5 | Last 3 |
|------|---------------:|-------:|-------:|
| LAC | 10.125 | 10.125 | 10.125 |
| LV | 6.750 | 6.750 | 6.750 |
