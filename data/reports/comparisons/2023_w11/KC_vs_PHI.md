...
| --- | ---: | ---: | ---: | ---: |
| EPA Offense | 35% | -0.119 | -0.074 | -0.045 |
| EPA Defense | 20% | -0.074 | -0.119 | +0.045 |
| Success Rate Offense | 25% | 34.3% | 38.6% | -4.2 pp |
| Tempo | 20% | 0.091 | 0.100 | -0.009 |

## PowerScore Breakdown (7 Metrics)

| Component | Weight | KC | PHI | Delta |
| --- | ---: | ---: | ---: | ---: |
| EPA Offense | 25% | -0.119 | -0.074 | -0.045 |
| EPA Defense | 20% | -0.074 | -0.119 | +0.045 |
| Success Rate Offense | 15% | 34.3% | 38.6% | -4.2 pp |
| Turnover Margin | 10% | -1.000 | 1.000 | -2.000 |
| Tempo | 10% | 0.091 | 0.100 | -0.009 |
| Red Zone TD Rate (Off) | 10% | 18.2% | 37.5% | -19.3 pp |
| Pressure Rate (Def) | 10% | 16.7% | 2.3% | +14.4 pp |

## PowerScore Summary

**Model (4 metrics):**
PHI edge: +0.019 (KC +0.048 vs PHI +0.067)
**7 metrics version:**
...
| --- | ---: | ---: | ---: | ---: | ---: | --- |
| KC | 44.4% | 45.8% | -1.4% | 31.8% | 36.4% | Slight run lean |
| PHI | 42.9% | 45.8% | -3.0% | 30.0% | 45.0% | Slight run lean |
...
| --- | ---: | ---: | ---: |
| KC | +1.2 pp | +2.1 pp | -6.6 pp |
| PHI | +13.1 pp | +17.0 pp | +13.0 pp |

### Red Zone TD Rate

| Team | Season-to-date | Last 5 | Last 3 |
| --- | ---: | ---: | ---: |
| KC | -0.3 pp | +5.3 pp | +9.2 pp |
| PHI | -3.6 pp | -7.2 pp | +2.4 pp |

### Pass Protection vs Pressure

| Team | Season-to-date | Last 5 | Last 3 |
| --- | ---: | ---: | ---: |
| KC | +4.6 pp | +4.1 pp | +2.6 pp |
| PHI | +3.5 pp | +7.2 pp | +7.2 pp |

### Explosive Plays

| Team | Season-to-date | Last 5 | Last 3 |
| --- | ---: | ---: | ---: |
| KC | -0.4 pp | -2.4 pp | -3.6 pp |
| PHI | +0.9 pp | +1.0 pp | +1.6 pp |
...
| Team | Season-to-date | Last 5 | Last 3 |
| --- | ---: | ---: | ---: |
| KC | +1.4 pp | -1.4 pp | -0.7 pp |
| PHI | +4.1 pp | -2.5 pp | +0.3 pp |

### Pass Success Edge

| Team | Season-to-date | Last 5 | Last 3 |
| --- | ---: | ---: | ---: |
| KC | +2.4 pp | +3.4 pp | -4.5 pp |
| PHI | +9.8 pp | +13.7 pp | +12.1 pp |
...
| --- | --- | --- | --- | --- |
| Off EPA KC | 0.201 | -0.234 | 0.023 | - declining |
| Off EPA PHI | 0.074 | 0.217 | 0.209 | + improving |
| Def EPA KC | 0.040 | -0.015 | -0.065 | + improving |
| Def EPA PHI | -0.132 | 0.066 | 0.150 | - declining |
| Off SR KC | 47.0% | 38.9% | 45.3% | - declining |
| Off SR PHI | 47.6% | 42.5% | 49.4% | + improving |
| Def SR KC | 36.2% | 44.2% | 45.0% | - declining |
| Def SR PHI | 42.4% | 48.9% | 47.8% | - declining |
| Tempo KC | 7.545 | 6.545 | 6.250 | - declining |
| Tempo PHI | 8.400 | 6.667 | 8.100 | - declining |
...
| ---: | --- | --- | --- | ---: | ---: | ---: | ---: |
| 7 | LAC (H) | 31-17 | KC | 0.864 | 0.201 | 47.0% | 1.273 |
| 9 | MIA (H) | 15-14 | KC | 0.861 | 0.023 | 45.3% | 0.083 |
| 1 | DET (H) | 20-14 | KC | 0.844 | -0.079 | 39.5% | 0.568 |

**PHI analogs vs KC profile**

| Week | Opponent | Score | Winner | Similarity | EPA Off | Success Rate | PPD Diff |
| ---: | --- | --- | --- | ---: | ---: | ---: | ---: |
| 9 | DAL (H) | 28-25 | PHI | 0.971 | 0.209 | 49.4% | 0.300 |
| 2 | MIN (H) | 34-31 | PHI | 0.887 | 0.116 | 49.0% | 0.288 |
| 7 | MIA (H) | 31-12 | PHI | 0.659 | 0.074 | 47.6% | 1.878 |

## Core EPA Offense Form (up to Week 10)

| Team | Season-to-date | Last 5 | Last 3 |
|------|---------------:|-------:|-------:|
| KC | 0.032 | 0.022 | -0.003 |
| PHI | 0.090 | 0.097 | 0.167 |

## Core EPA Defense Form (up to Week 10)

| Team | Season-to-date | Last 5 | Last 3 |
|------|---------------:|-------:|-------:|
| KC | -0.076 | -0.045 | -0.013 |
| PHI | -0.010 | -0.002 | 0.028 |
...
| Team | Season-to-date | Last 5 | Last 3 |
|------|---------------:|-------:|-------:|
| KC | 0.701 | 0.325 | 0.000 |
| PHI | 0.437 | 0.616 | 0.811 |

## Yards per Play Differential Form (up to Week 10)

| Team | Season-to-date | Last 5 | Last 3 |
|------|---------------:|-------:|-------:|
| KC | 0.849 | 0.794 | 0.756 |
| PHI | 0.300 | 0.307 | -0.315 |

## Turnover Margin Form (up to Week 10)

| Team | Season-to-date | Last 5 | Last 3 |
|------|---------------:|-------:|-------:|
| KC | 0.000 | 0.200 | -0.667 |
| PHI | -0.444 | -1.200 | -0.333 |
...
| Team | Season-to-date | Last 5 | Last 3 |
|------|---------------:|-------:|-------:|
| KC | 7.754 | 7.664 | 6.780 |
| PHI | 8.278 | 8.568 | 7.722 |
