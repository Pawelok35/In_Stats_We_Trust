# Matchup Report - SF vs LAR

## PowerScore Breakdown (Model)

| Component | Weight | SF | LAR | Delta |
| --- | ---: | ---: | ---: | ---: |
...
| Metric | Value |
| --- | --- |
| Model Spread (SF - LAR) | +1.9 pts (favours SF) |
| Model Win% SF | 58.0% |
| Model Win% LAR | 42.0% |
| SOS Differential (SF-LAR) | n/a |
...
| LAR | 39.6% | n/a | n/a | 45.7% | 61.9% | n/a |
...
| --- | ---: | ---: | ---: |
| SF | +20.4 pp | +20.8 pp | +23.5 pp |
| LAR | +5.7 pp | +5.7 pp | +5.7 pp |

### Red Zone TD Rate

| Team | Season-to-date | Last 5 | Last 3 |
| --- | ---: | ---: | ---: |
| SF | +2.7 pp | +6.0 pp | +11.2 pp |
| LAR | +3.8 pp | +3.8 pp | +3.8 pp |

### Pass Protection vs Pressure

| Team | Season-to-date | Last 5 | Last 3 |
| --- | ---: | ---: | ---: |
| SF | -2.6 pp | -2.6 pp | -2.6 pp |
| LAR | -1.4 pp | -1.4 pp | -0.9 pp |

### Explosive Plays

| Team | Season-to-date | Last 5 | Last 3 |
| --- | ---: | ---: | ---: |
| SF | +1.1 pp | +2.0 pp | +3.7 pp |
| LAR | +1.5 pp | +1.5 pp | +1.5 pp |
