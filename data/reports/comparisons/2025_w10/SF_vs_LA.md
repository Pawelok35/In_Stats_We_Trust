...
| Tempo | 8.667 | 8.500 | 0.167 |
| PowerScore | 1.982 | 1.996 | -0.015 |
| PowerScore | 1.982 | 1.996 | -0.015 |
| Tempo | 8.667 | 8.500 | 0.167 |
...
| --- | ---: | ---: | ---: | ---: |
| EPA Offense | 35% | 0.109 | 0.331 | -0.222 |
| EPA Defense | 20% | 0.331 | 0.109 | +0.222 |
| Success Rate Offense | 25% | 57.7% | 63.5% | -5.8 pp |
| Tempo | 20% | 0.090 | 0.118 | -0.028 |

## PowerScore Breakdown (7 Metrics)

| Component | Weight | SF | LA | Delta |
| --- | ---: | ---: | ---: | ---: |
| EPA Offense | 25% | 0.109 | 0.331 | -0.222 |
| EPA Defense | 20% | 0.331 | 0.109 | +0.222 |
| Success Rate Offense | 15% | 57.7% | 63.5% | -5.8 pp |
| Turnover Margin | 10% | -2.000 | 2.000 | -4.000 |
| Tempo | 10% | 0.090 | 0.118 | -0.028 |
| Red Zone TD Rate (Off) | 10% | 18.2% | 26.3% | -8.1 pp |
| Pressure Rate (Def) | 10% | 2.5% | 0.0% | +2.5 pp |

## PowerScore Summary

**Model (4 metrics):**
LA edge: +0.053 (SF +0.266 vs LA +0.320)
**7 metrics version:**
LA edge: +0.428 (SF +0.009 vs LA +0.438)
**Verdict:** LA holds the edge in the extended breakdown (lead 0.428), driven by Turnover Margin (10% weight).
### Risk flags
...
| Metric | Value |
| --- | --- |
| Model Spread (SF - LA) | -0.3 pts (favours LA) |
| Model Win% SF | 48.9% |
| Model Win% LA | 51.1% |
| SOS Differential (SF-LA) | +0.010 |
...
| --- | ---: | ---: | ---: | ---: | ---: | --- |
| SF | 51.3% | 42.4% | 8.8% | 62.5% | 52.6% | Pass heavy |
| LA | 47.1% | 42.4% | 4.6% | 60.0% | 66.7% | Pass heavy |
...
| --- | ---: | ---: | ---: |
| SF | +12.7 pp | +13.1 pp | +21.0 pp |
| LA | +1.0 pp | -6.1 pp | -10.2 pp |

### Red Zone TD Rate

| Team | Season-to-date | Last 5 | Last 3 |
| --- | ---: | ---: | ---: |
| SF | +6.3 pp | +9.1 pp | +19.5 pp |
| LA | -0.1 pp | +0.3 pp | +1.9 pp |

### Pass Protection vs Pressure

| Team | Season-to-date | Last 5 | Last 3 |
| --- | ---: | ---: | ---: |
| SF | +3.1 pp | -0.1 pp | +2.4 pp |
| LA | -0.6 pp | -0.2 pp | +0.4 pp |

### Explosive Plays

| Team | Season-to-date | Last 5 | Last 3 |
| --- | ---: | ---: | ---: |
| SF | +1.6 pp | +2.4 pp | +4.0 pp |
| LA | +2.0 pp | -0.8 pp | -0.5 pp |
...
| Team | Season-to-date | Last 5 | Last 3 |
| --- | ---: | ---: | ---: |
| SF | +4.7 pp | +4.9 pp | +5.9 pp |
| LA | +0.8 pp | +0.2 pp | -1.2 pp |

### Pass Success Edge

| Team | Season-to-date | Last 5 | Last 3 |
| --- | ---: | ---: | ---: |
| SF | +7.9 pp | +4.8 pp | +8.1 pp |
| LA | +1.8 pp | +0.9 pp | +3.6 pp |
...
| Window | SF | LA |
| --- | ---: | ---: |
| Season-to-date | 1.693 | 1.683 |
| Last 5 games | 1.761 | 1.710 |
| Last 3 games | 1.883 | 1.676 |

## Trend Summary (last 3 weeks)

| Metric | W6 | W7 | W9 | Trend |
| --- | --- | --- | --- | --- |
| Off EPA SF | 0.016 | 0.043 | 0.279 | + improving |
| Off EPA LA | -0.084 | 0.245 | 0.172 | + improving |
| Def EPA SF | 0.157 | -0.077 | 0.109 | + improving |
| Def EPA LA | -0.263 | -0.114 | -0.211 | - declining |
| Off SR SF | 50.0% | 51.9% | 53.0% | + improving |
| Off SR LA | 46.2% | 51.7% | 53.1% | + improving |
| Def SR SF | 53.6% | 44.2% | 54.5% | = stable |
| Def SR LA | 40.4% | 45.7% | 40.7% | = stable |
| Tempo SF | 8.800 | 8.778 | 7.545 | - declining |
| Tempo LA | 6.500 | 7.250 | 9.600 | + improving |
