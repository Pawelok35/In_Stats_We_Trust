...
| Metric | ARI | LA | Delta |
|---|---:|---:|---:|
| Core EPA Offense | 0.053 | 0.066 | -0.013 |
| Core EPA Defense | -0.100 | -0.021 | -0.079 |
| Success Rate Offense | 0.461 | 0.463 | -0.001 |
| Success Rate Defense | 0.417 | 0.437 | -0.020 |
| Explosive Play Rate (Off) | 0.104 | 0.114 | -0.010 |
| Third Down Conversion | 0.370 | 0.377 | -0.007 |
| Points per Drive Differential | 1.046 | 0.696 | 0.350 |
| Yards per Play Differential | 0.450 | 0.913 | -0.463 |
...
| --- | ---: | ---: | ---: |
| ARI | -1.0 pp | -0.2 pp | -8.2 pp |
| LA | +7.6 pp | -2.0 pp | +1.8 pp |

### Red Zone TD Rate

| Team | Season-to-date | Last 5 | Last 3 |
| --- | ---: | ---: | ---: |
| ARI | +3.7 pp | -0.7 pp | -0.2 pp |
| LA | +2.2 pp | -1.4 pp | -1.2 pp |

### Pass Protection vs Pressure

| Team | Season-to-date | Last 5 | Last 3 |
| --- | ---: | ---: | ---: |
| ARI | +0.1 pp | +0.0 pp | -2.9 pp |
| LA | +3.5 pp | +1.9 pp | +2.7 pp |

### Explosive Plays

| Team | Season-to-date | Last 5 | Last 3 |
| --- | ---: | ---: | ---: |
| ARI | +1.5 pp | +2.6 pp | +2.5 pp |
| LA | +1.5 pp | -0.9 pp | -2.3 pp |
...
| Team | Season-to-date | Last 5 | Last 3 |
| --- | ---: | ---: | ---: |
| ARI | +3.1 pp | +4.0 pp | +4.0 pp |
| LA | +2.6 pp | -1.9 pp | -1.1 pp |

### Pass Success Edge

| Team | Season-to-date | Last 5 | Last 3 |
| --- | ---: | ---: | ---: |
| ARI | +3.4 pp | +6.4 pp | +2.8 pp |
| LA | +6.6 pp | +3.9 pp | +4.7 pp |
...
| Window | ARI | LA |
| --- | ---: | ---: |
| Season-to-date | 1.570 | 1.708 |
| Last 5 games | 1.664 | 1.503 |
| Last 3 games | 1.625 | 1.596 |

## Trend Summary (last 3 weeks)

| Metric | W9 | W10 | W13 | Trend |
| --- | --- | --- | --- | --- |
| Off EPA ARI | 0.181 | -0.384 | 0.129 | - declining |
| Off EPA LA | -0.215 | -0.164 | 0.227 | + improving |
| Def EPA ARI | -0.053 | 0.040 | -0.079 | + improving |
| Def EPA LA | -0.071 | 0.141 | -0.229 | + improving |
| Off SR ARI | 45.3% | 30.6% | 49.3% | + improving |
| Off SR LA | 39.4% | 36.6% | 53.7% | + improving |
| Def SR ARI | 46.7% | 49.4% | 40.9% | + improving |
| Def SR LA | 41.6% | 45.8% | 34.7% | + improving |
| Tempo ARI | 7.818 | 6.000 | 6.900 | - declining |
| Tempo LA | 8.545 | 7.100 | 8.200 | - declining |
...
| Team | Season-to-date | Last 5 | Last 3 |
|------|---------------:|-------:|-------:|
| ARI | 0.053 | 0.016 | -0.055 |
| LA | 0.066 | -0.006 | 0.003 |

## Core EPA Defense Form (up to Week 13)

| Team | Season-to-date | Last 5 | Last 3 |
|------|---------------:|-------:|-------:|
| ARI | -0.100 | -0.007 | -0.034 |
| LA | -0.021 | -0.036 | -0.013 |
...
| Team | Season-to-date | Last 5 | Last 3 |
|------|---------------:|-------:|-------:|
| ARI | 1.042 | 0.251 | -0.094 |
| LA | 0.695 | 0.477 | 0.401 |

## Yards per Play Differential Form (up to Week 13)

| Team | Season-to-date | Last 5 | Last 3 |
|------|---------------:|-------:|-------:|
| ARI | 0.450 | 0.040 | -0.442 |
| LA | 0.913 | 1.147 | 0.935 |

## Turnover Margin Form (up to Week 13)

| Team | Season-to-date | Last 5 | Last 3 |
|------|---------------:|-------:|-------:|
| ARI | 1.167 | 1.200 | 1.333 |
| LA | 0.250 | -0.400 | -0.667 |
...
| Team | Season-to-date | Last 5 | Last 3 |
|------|---------------:|-------:|-------:|
| ARI | 7.776 | 7.899 | 7.600 |
| LA | 7.457 | 7.324 | 7.052 |
