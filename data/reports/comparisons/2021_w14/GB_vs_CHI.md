...
| Metric | GB | CHI | Delta |
|---|---:|---:|---:|
| Core EPA Offense | 0.071 | -0.084 | 0.155 |
| Core EPA Defense | 0.011 | 0.029 | -0.018 |
| Success Rate Offense | 0.451 | 0.400 | 0.051 |
| Success Rate Defense | 0.461 | 0.444 | 0.017 |
| Explosive Play Rate (Off) | 0.099 | 0.094 | 0.005 |
| Third Down Conversion | 0.366 | 0.283 | 0.083 |
| Points per Drive Differential | 0.273 | -0.752 | 1.025 |
| Yards per Play Differential | 0.304 | -0.518 | 0.822 |
...
| --- | ---: | ---: | ---: |
| GB | +1.3 pp | +1.6 pp | +7.4 pp |
| CHI | -11.7 pp | -9.9 pp | -19.2 pp |

### Red Zone TD Rate

| Team | Season-to-date | Last 5 | Last 3 |
| --- | ---: | ---: | ---: |
| GB | -1.7 pp | -3.7 pp | -3.9 pp |
| CHI | -5.0 pp | -3.6 pp | -2.2 pp |

### Pass Protection vs Pressure

| Team | Season-to-date | Last 5 | Last 3 |
| --- | ---: | ---: | ---: |
| GB | +2.7 pp | +4.0 pp | +4.6 pp |
| CHI | -4.7 pp | -3.4 pp | -0.9 pp |

### Explosive Plays

| Team | Season-to-date | Last 5 | Last 3 |
| --- | ---: | ---: | ---: |
| GB | -1.1 pp | -2.0 pp | +0.8 pp |
| CHI | +0.5 pp | +3.1 pp | +0.7 pp |
...
| Team | Season-to-date | Last 5 | Last 3 |
| --- | ---: | ---: | ---: |
| GB | +0.4 pp | -0.1 pp | +0.1 pp |
| CHI | -7.7 pp | -10.3 pp | -13.7 pp |

### Pass Success Edge

| Team | Season-to-date | Last 5 | Last 3 |
| --- | ---: | ---: | ---: |
| GB | +0.8 pp | -0.7 pp | -0.1 pp |
| CHI | -5.6 pp | -2.0 pp | -4.3 pp |
...
| Window | GB | CHI |
| --- | ---: | ---: |
| Season-to-date | 1.666 | 1.638 |
| Last 5 games | 1.639 | 1.625 |
| Last 3 games | 1.565 | 1.582 |

## Trend Summary (last 3 weeks)

| Metric | W9 | W11 | W12 | Trend |
| --- | --- | --- | --- | --- |
| Off EPA GB | -0.095 | 0.251 | 0.051 | + improving |
| Off EPA CHI | 0.048 | -0.099 | -0.073 | - declining |
| Def EPA GB | -0.017 | 0.247 | -0.053 | + improving |
| Def EPA CHI | 0.076 | -0.035 | -0.137 | + improving |
| Off SR GB | 36.8% | 44.7% | 40.8% | + improving |
| Off SR CHI | 42.4% | 32.9% | 35.3% | - declining |
| Def SR GB | 39.5% | 47.7% | 42.7% | - declining |
| Def SR CHI | 41.3% | 44.3% | 37.3% | + improving |
| Tempo GB | 7.600 | 8.444 | 7.357 | - declining |
| Tempo CHI | 6.538 | 6.333 | 8.500 | + improving |
...
| Team | Season-to-date | Last 5 | Last 3 |
|------|---------------:|-------:|-------:|
| CHI | -0.084 | -0.027 | -0.084 |
| GB | 0.071 | 0.072 | 0.111 |

## Core EPA Defense Form (up to Week 13)

| Team | Season-to-date | Last 5 | Last 3 |
|------|---------------:|-------:|-------:|
| CHI | 0.029 | 0.064 | -0.014 |
| GB | 0.011 | 0.001 | -0.013 |
...
| Team | Season-to-date | Last 5 | Last 3 |
|------|---------------:|-------:|-------:|
| CHI | -0.774 | -0.543 | -0.420 |
| GB | 0.290 | 0.233 | 0.588 |

## Yards per Play Differential Form (up to Week 13)

| Team | Season-to-date | Last 5 | Last 3 |
|------|---------------:|-------:|-------:|
| CHI | -0.518 | 0.271 | 0.759 |
| GB | 0.304 | 0.531 | 0.854 |

## Turnover Margin Form (up to Week 13)

| Team | Season-to-date | Last 5 | Last 3 |
|------|---------------:|-------:|-------:|
| CHI | -0.833 | -1.600 | -1.333 |
| GB | 0.750 | 0.800 | 1.000 |
...
| Team | Season-to-date | Last 5 | Last 3 |
|------|---------------:|-------:|-------:|
| CHI | 7.873 | 8.284 | 8.044 |
| GB | 7.877 | 8.180 | 8.134 |
