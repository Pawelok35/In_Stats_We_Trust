...
| PowerScore | 1.544 | 1.996 | -0.452 |
| PowerScore | 1.544 | 1.996 | -0.452 |
| Tempo | 6.286 | 8.500 | -2.214 |

## PowerScore Breakdown (Model)

| Component | Weight | CIN | CHI | Delta |
| --- | ---: | ---: | ---: | ---: |
| EPA Offense | 35% | 0.247 | 0.306 | -0.059 |
| EPA Defense | 20% | 0.306 | 0.247 | +0.059 |
| Success Rate Offense | 25% | 55.7% | 55.9% | -0.2 pp |
| Tempo | 20% | 0.159 | 0.147 | +0.012 |

## PowerScore Breakdown (7 Metrics)

| Component | Weight | CIN | CHI | Delta |
| --- | ---: | ---: | ---: | ---: |
| EPA Offense | 25% | 0.247 | 0.306 | -0.059 |
| EPA Defense | 20% | 0.306 | 0.247 | +0.059 |
| Success Rate Offense | 15% | 55.7% | 55.9% | -0.2 pp |
| Turnover Margin | 10% | -3.000 | 3.000 | -6.000 |
| Tempo | 10% | 0.159 | 0.147 | +0.012 |
| Red Zone TD Rate (Off) | 10% | 13.3% | 14.8% | -1.5 pp |
| Pressure Rate (Def) | 10% | 5.0% | 7.7% | -2.7 pp |

## PowerScore Summary

**Model (4 metrics):**
CHI edge: +0.007 (CIN +0.319 vs CHI +0.326)
**7 metrics version:**
...
| Metric | Value |
| --- | --- |
| Model Spread (CIN - CHI) | -8.4 pts (favours CHI) |
| Model Win% CIN | 19.9% |
| Model Win% CHI | 80.1% |
| SOS Differential (CIN-CHI) | +0.210 |
...
| --- | ---: | ---: | ---: | ---: | ---: | --- |
| CIN | 59.1% | 45.1% | 14.0% | 53.8% | 58.3% | Pass heavy |
| CHI | 39.2% | 45.1% | -5.8% | 47.5% | 61.3% | Run heavy |
...
| --- | ---: | ---: | ---: |
| CIN | +7.3 pp | +5.8 pp | +11.0 pp |
| CHI | -9.1 pp | -11.7 pp | -24.9 pp |

### Red Zone TD Rate

| Team | Season-to-date | Last 5 | Last 3 |
| --- | ---: | ---: | ---: |
| CIN | -0.9 pp | -1.5 pp | -3.9 pp |
| CHI | -6.3 pp | -11.8 pp | -11.4 pp |

### Pass Protection vs Pressure

| Team | Season-to-date | Last 5 | Last 3 |
| --- | ---: | ---: | ---: |
| CIN | -0.3 pp | +1.9 pp | +6.9 pp |
| CHI | -0.5 pp | -0.1 pp | -3.8 pp |

### Explosive Plays

| Team | Season-to-date | Last 5 | Last 3 |
| --- | ---: | ---: | ---: |
| CIN | -1.8 pp | +0.9 pp | +3.7 pp |
| CHI | +0.3 pp | -1.3 pp | -0.9 pp |
...
| Team | Season-to-date | Last 5 | Last 3 |
| --- | ---: | ---: | ---: |
| CIN | +4.2 pp | +8.7 pp | +14.6 pp |
| CHI | -3.8 pp | -5.7 pp | -7.0 pp |

### Pass Success Edge

| Team | Season-to-date | Last 5 | Last 3 |
| --- | ---: | ---: | ---: |
| CIN | -7.6 pp | -4.9 pp | +3.1 pp |
| CHI | -11.7 pp | -11.6 pp | -12.9 pp |
...
| Window | CIN | CHI |
| --- | ---: | ---: |
| Season-to-date | 1.748 | 1.538 |
| Last 5 games | 1.834 | 1.610 |
| Last 3 games | 1.870 | 1.630 |

## Trend Summary (last 3 weeks)

| Metric | W6 | W7 | W8 | Trend |
| --- | --- | --- | --- | --- |
| Off EPA CIN | 0.096 | 0.219 | 0.249 | + improving |
| Off EPA CHI | 0.093 | -0.010 | 0.041 | - declining |
| Def EPA CIN | 0.216 | 0.262 | 0.243 | - declining |
| Def EPA CHI | 0.036 | -0.231 | 0.227 | - declining |
| Off SR CIN | 53.1% | 53.7% | 65.8% | + improving |
| Off SR CHI | 50.6% | 43.8% | 46.9% | - declining |
| Def SR CIN | 58.7% | 54.7% | 56.0% | + improving |
| Def SR CHI | 49.4% | 42.9% | 55.0% | - declining |
| Tempo CIN | 9.000 | 9.500 | 7.600 | - declining |
| Tempo CHI | 7.900 | 7.417 | 9.000 | + improving |

## Matchup Analogs

**CIN analogs vs CHI profile**
...
| Team | Season-to-date | Last 5 | Last 3 |
|------|---------------:|-------:|-------:|
| CHI | 0.003 | 0.051 | 0.041 |
| CIN | -0.013 | 0.078 | 0.188 |

## Core EPA Defense Form (up to Week 8)

| Team | Season-to-date | Last 5 | Last 3 |
|------|---------------:|-------:|-------:|
| CHI | 0.013 | -0.029 | 0.010 |
| CIN | 0.138 | 0.215 | 0.241 |
...
| Team | Season-to-date | Last 5 | Last 3 |
|------|---------------:|-------:|-------:|
| CHI | -0.361 | 0.344 | -0.003 |
| CIN | -0.697 | -0.793 | -0.154 |

## Yards per Play Differential Form (up to Week 8)

| Team | Season-to-date | Last 5 | Last 3 |
|------|---------------:|-------:|-------:|
| CHI | -0.396 | -0.012 | 0.512 |
| CIN | -1.285 | -1.284 | -0.925 |

## Turnover Margin Form (up to Week 8)

| Team | Season-to-date | Last 5 | Last 3 |
|------|---------------:|-------:|-------:|
| CHI | 1.429 | 2.400 | 1.667 |
| CIN | -0.250 | 0.400 | 1.000 |
...
| Team | Season-to-date | Last 5 | Last 3 |
|------|---------------:|-------:|-------:|
| CHI | 7.531 | 7.905 | 8.106 |
| CIN | 7.460 | 7.913 | 8.700 |
