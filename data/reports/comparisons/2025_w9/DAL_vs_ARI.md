...
| --- | ---: | ---: | ---: | ---: |
| EPA Offense | 35% | -0.122 | 0.053 | -0.175 |
| EPA Defense | 20% | 0.053 | -0.122 | +0.175 |
| Success Rate Offense | 25% | 46.2% | 50.0% | -3.7 pp |
| Tempo | 20% | 0.125 | 0.146 | -0.021 |

## PowerScore Breakdown (7 Metrics)

| Component | Weight | DAL | ARI | Delta |
| --- | ---: | ---: | ---: | ---: |
| EPA Offense | 25% | -0.122 | 0.053 | -0.175 |
| EPA Defense | 20% | 0.053 | -0.122 | +0.175 |
| Success Rate Offense | 15% | 46.2% | 50.0% | -3.7 pp |
| Turnover Margin | 10% | -3.000 | 3.000 | -6.000 |
| Tempo | 10% | 0.125 | 0.146 | -0.021 |
| Red Zone TD Rate (Off) | 10% | 6.7% | 17.6% | -11.0 pp |
| Pressure Rate (Def) | 10% | 13.2% | 11.4% | +1.8 pp |

## PowerScore Summary

**Model (4 metrics):**
ARI edge: +0.040 (DAL +0.108 vs ARI +0.148)
**7 metrics version:**
...
| Metric | Value |
| --- | --- |
| Model Spread (DAL - ARI) | -1.4 pts (favours ARI) |
| Model Win% DAL | 44.2% |
| Model Win% ARI | 55.8% |
| SOS Differential (DAL-ARI) | +0.073 |
...
| --- | ---: | ---: | ---: | ---: | ---: | --- |
| DAL | 55.0% | 45.1% | 9.9% | 40.9% | 52.8% | Pass heavy |
| ARI | 46.3% | 45.1% | 1.3% | 47.4% | 52.3% | Slight pass lean |
...
| --- | ---: | ---: | ---: |
| DAL | +4.5 pp | +1.5 pp | -3.7 pp |
| ARI | -5.4 pp | +1.5 pp | +12.2 pp |

### Red Zone TD Rate

| Team | Season-to-date | Last 5 | Last 3 |
| --- | ---: | ---: | ---: |
| DAL | +1.2 pp | -0.8 pp | -7.7 pp |
| ARI | -0.9 pp | -1.0 pp | -0.9 pp |

### Pass Protection vs Pressure

| Team | Season-to-date | Last 5 | Last 3 |
| --- | ---: | ---: | ---: |
| DAL | +1.2 pp | +1.9 pp | +0.8 pp |
| ARI | -4.2 pp | -3.4 pp | -4.3 pp |

### Explosive Plays

| Team | Season-to-date | Last 5 | Last 3 |
| --- | ---: | ---: | ---: |
| DAL | -1.7 pp | -3.3 pp | -4.2 pp |
| ARI | -2.4 pp | -3.4 pp | -1.8 pp |
...
| Team | Season-to-date | Last 5 | Last 3 |
| --- | ---: | ---: | ---: |
| DAL | +1.3 pp | -4.7 pp | -10.2 pp |
| ARI | -6.6 pp | -6.6 pp | -9.9 pp |

### Pass Success Edge

| Team | Season-to-date | Last 5 | Last 3 |
| --- | ---: | ---: | ---: |
| DAL | -1.0 pp | -0.1 pp | +4.8 pp |
| ARI | -4.5 pp | -7.0 pp | -2.8 pp |
...
| Window | DAL | ARI |
| --- | ---: | ---: |
| Season-to-date | 1.785 | 1.712 |
| Last 5 games | 1.800 | 1.613 |
| Last 3 games | 1.671 | 1.580 |
...
| Off EPA ARI | -0.063 | 0.117 | 0.039 | + improving |
| Def EPA DAL | 0.025 | 0.153 | -0.106 | + improving |
| Def EPA ARI | -0.026 | 0.164 | 0.123 | - declining |
| Off SR DAL | 47.6% | 45.2% | 46.5% | - declining |
| Off SR ARI | 38.6% | 51.1% | 48.9% | + improving |
| Def SR DAL | 50.0% | 56.5% | 47.2% | + improving |
| Def SR ARI | 45.1% | 56.6% | 53.4% | - declining |
| Tempo DAL | 6.833 | 8.111 | 6.615 | - declining |
| Tempo ARI | 6.769 | 9.000 | 9.778 | + improving |
...
| ---: | --- | --- | --- | ---: | ---: | ---: | ---: |
| 3 | CHI (A) | 14-31 | CHI | 0.719 | -0.005 | 48.3% | -1.700 |
| 2 | NYG (H) | 40-46 | NYG | 0.706 | 0.134 | 48.7% | -0.417 |
| 5 | NYJ (A) | 37-22 | DAL | 0.528 | 0.258 | 47.6% | 1.250 |
...
| Team | Season-to-date | Last 5 | Last 3 |
|------|---------------:|-------:|-------:|
| ARI | 0.020 | 0.017 | 0.031 |
| DAL | 0.148 | 0.183 | 0.143 |

## Core EPA Defense Form (up to Week 8)

| Team | Season-to-date | Last 5 | Last 3 |
|------|---------------:|-------:|-------:|
| ARI | 0.029 | 0.060 | 0.087 |
| DAL | 0.150 | 0.129 | 0.126 |
...
| Team | Season-to-date | Last 5 | Last 3 |
|------|---------------:|-------:|-------:|
| ARI | -0.015 | -0.175 | -0.009 |
| DAL | -0.134 | 0.226 | 0.051 |

## Yards per Play Differential Form (up to Week 8)

| Team | Season-to-date | Last 5 | Last 3 |
|------|---------------:|-------:|-------:|
| ARI | -0.333 | -0.618 | 0.012 |
| DAL | -0.301 | -0.065 | -0.562 |

## Turnover Margin Form (up to Week 8)

| Team | Season-to-date | Last 5 | Last 3 |
|------|---------------:|-------:|-------:|
| ARI | -0.143 | -0.400 | -0.333 |
| DAL | -0.125 | 0.800 | 0.667 |
...
| Team | Season-to-date | Last 5 | Last 3 |
|------|---------------:|-------:|-------:|
| ARI | 8.135 | 8.189 | 8.516 |
| DAL | 8.005 | 7.657 | 7.757 |
