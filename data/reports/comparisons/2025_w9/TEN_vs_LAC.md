...
| --- | ---: | ---: | ---: | ---: |
| EPA Offense | 35% | -0.151 | -0.002 | -0.149 |
| EPA Defense | 20% | -0.002 | -0.151 | +0.149 |
| Success Rate Offense | 25% | 37.5% | 54.2% | -16.7 pp |
...
| Component | Weight | TEN | LAC | Delta |
| --- | ---: | ---: | ---: | ---: |
| EPA Offense | 25% | -0.151 | -0.002 | -0.149 |
| EPA Defense | 20% | -0.002 | -0.151 | +0.149 |
| Success Rate Offense | 15% | 37.5% | 54.2% | -16.7 pp |
| Turnover Margin | 10% | 1.000 | -1.000 | +2.000 |
| Tempo | 10% | 0.125 | 0.108 | +0.017 |
| Red Zone TD Rate (Off) | 10% | 0.0% | 20.0% | -20.0 pp |
| Pressure Rate (Def) | 10% | 16.7% | 16.0% | +0.7 pp |

## PowerScore Summary

**Model (4 metrics):**
LAC edge: +0.061 (TEN +0.066 vs LAC +0.127)
**7 metrics version:**
...
| Metric | Value |
| --- | --- |
| Model Spread (TEN - LAC) | -1.1 pts (favours LAC) |
| Model Win% TEN | 45.3% |
| Model Win% LAC | 54.7% |
| SOS Differential (TEN-LAC) | -0.001 |
...
| --- | ---: | ---: | ---: | ---: | ---: | --- |
| TEN | 39.1% | 45.1% | -6.0% | 40.0% | 35.9% | Run heavy |
| LAC | 43.4% | 45.1% | -1.7% | 52.8% | 55.3% | Slight run lean |
...
| --- | ---: | ---: | ---: |
| TEN | -4.9 pp | -6.0 pp | -9.4 pp |
| LAC | +9.4 pp | +8.8 pp | +15.2 pp |

### Red Zone TD Rate

| Team | Season-to-date | Last 5 | Last 3 |
| --- | ---: | ---: | ---: |
| TEN | -3.7 pp | -6.7 pp | -8.9 pp |
| LAC | -9.1 pp | -13.3 pp | -3.9 pp |

### Pass Protection vs Pressure

| Team | Season-to-date | Last 5 | Last 3 |
| --- | ---: | ---: | ---: |
| TEN | -3.0 pp | -0.3 pp | -5.4 pp |
| LAC | -0.4 pp | +3.1 pp | +5.9 pp |

### Explosive Plays

| Team | Season-to-date | Last 5 | Last 3 |
| --- | ---: | ---: | ---: |
| TEN | -2.0 pp | -0.7 pp | -0.3 pp |
| LAC | -2.5 pp | -1.4 pp | -1.4 pp |
...
| Team | Season-to-date | Last 5 | Last 3 |
| --- | ---: | ---: | ---: |
| TEN | -3.0 pp | -6.3 pp | -7.0 pp |
| LAC | +3.1 pp | +8.6 pp | +3.2 pp |

### Pass Success Edge

| Team | Season-to-date | Last 5 | Last 3 |
| --- | ---: | ---: | ---: |
| TEN | -3.0 pp | -7.0 pp | +0.8 pp |
| LAC | +0.7 pp | -0.2 pp | +7.2 pp |
...
| Window | TEN | LAC |
| --- | ---: | ---: |
| Season-to-date | 0.144 | 0.145 |
| Last 5 games | 0.126 | 0.176 |
| Last 3 games | 0.158 | 0.183 |

## Trend Summary (last 3 weeks)

| Metric | W6 | W7 | W8 | Trend |
| --- | --- | --- | --- | --- |
| Off EPA TEN | -0.216 | -0.131 | -0.089 | + improving |
| Off EPA LAC | 0.128 | 0.090 | 0.170 | + improving |
| Def EPA TEN | -0.068 | 0.161 | 0.297 | - declining |
| Def EPA LAC | 0.061 | 0.367 | -0.255 | + improving |
| Off SR TEN | 40.8% | 47.8% | 43.2% | + improving |
| Off SR LAC | 50.0% | 47.8% | 54.5% | + improving |
| Def SR TEN | 43.6% | 46.3% | 47.8% | - declining |
| Def SR LAC | 48.7% | 55.4% | 37.3% | + improving |
| Tempo TEN | 7.600 | 6.700 | 8.000 | + improving |
| Tempo LAC | 8.400 | 11.500 | 9.778 | + improving |
...
| Team | Season-to-date | Last 5 | Last 3 |
|------|---------------:|-------:|-------:|
| LAC | 0.038 | 0.048 | 0.130 |
| TEN | -0.148 | -0.172 | -0.145 |

## Core EPA Defense Form (up to Week 8)

| Team | Season-to-date | Last 5 | Last 3 |
|------|---------------:|-------:|-------:|
| LAC | 0.015 | 0.066 | 0.058 |
| TEN | 0.094 | 0.079 | 0.130 |
...
| Team | Season-to-date | Last 5 | Last 3 |
|------|---------------:|-------:|-------:|
| LAC | 0.193 | -0.042 | 0.916 |
| TEN | -1.268 | -1.446 | -1.425 |

## Yards per Play Differential Form (up to Week 8)

| Team | Season-to-date | Last 5 | Last 3 |
|------|---------------:|-------:|-------:|
| LAC | 0.561 | 0.488 | 0.710 |
| TEN | -1.395 | -0.984 | -1.081 |

## Turnover Margin Form (up to Week 8)

| Team | Season-to-date | Last 5 | Last 3 |
|------|---------------:|-------:|-------:|
| LAC | -0.375 | -0.600 | 0.000 |
| TEN | -0.875 | -1.200 | -1.667 |
...
| Team | Season-to-date | Last 5 | Last 3 |
|------|---------------:|-------:|-------:|
| LAC | 8.730 | 9.052 | 9.893 |
| TEN | 7.286 | 7.002 | 7.433 |
