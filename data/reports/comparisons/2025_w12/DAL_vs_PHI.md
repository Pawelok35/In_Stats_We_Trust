...
| --- | ---: | ---: | ---: |
| DAL | +0.4 pp | -3.7 pp | -2.2 pp |
| PHI | -15.0 pp | -16.9 pp | -14.9 pp |

### Red Zone TD Rate

| Team | Season-to-date | Last 5 | Last 3 |
| --- | ---: | ---: | ---: |
| DAL | +3.6 pp | -0.5 pp | +2.1 pp |
| PHI | +1.3 pp | -4.3 pp | -3.9 pp |

### Pass Protection vs Pressure

| Team | Season-to-date | Last 5 | Last 3 |
| --- | ---: | ---: | ---: |
| DAL | +2.4 pp | +4.1 pp | +3.4 pp |
| PHI | -3.1 pp | -3.0 pp | -2.5 pp |

### Explosive Plays

| Team | Season-to-date | Last 5 | Last 3 |
| --- | ---: | ---: | ---: |
| DAL | -0.9 pp | -1.6 pp | -0.3 pp |
| PHI | -1.8 pp | -1.1 pp | -0.9 pp |
...
| Team | Season-to-date | Last 5 | Last 3 |
| --- | ---: | ---: | ---: |
| DAL | +0.0 pp | +1.7 pp | +5.6 pp |
| PHI | -5.0 pp | -7.2 pp | -3.9 pp |

### Pass Success Edge

| Team | Season-to-date | Last 5 | Last 3 |
| --- | ---: | ---: | ---: |
| DAL | +6.3 pp | +5.3 pp | +8.3 pp |
| PHI | -6.6 pp | -3.4 pp | -9.7 pp |
...
| Window | DAL | PHI |
| --- | ---: | ---: |
| Season-to-date | 0.213 | 0.139 |
| Last 5 games | 0.191 | 0.147 |
| Last 3 games | 0.187 | 0.126 |

## Trend Summary (last 3 weeks)

| Metric | W7 | W8 | W11 | Trend |
| --- | --- | --- | --- | --- |
| Off EPA DAL | 0.190 | 0.063 | 0.119 | - declining |
| Off EPA PHI | 0.065 | 0.307 | -0.147 | - declining |
| Def EPA DAL | -0.106 | 0.331 | -0.138 | + improving |
| Def EPA PHI | -0.019 | 0.097 | -0.295 | + improving |
| Off SR DAL | 46.5% | 55.3% | 57.3% | + improving |
| Off SR PHI | 42.6% | 58.2% | 41.9% | = stable |
| Def SR DAL | 47.2% | 59.5% | 46.2% | + improving |
| Def SR PHI | 54.2% | 48.6% | 34.7% | + improving |
| Tempo DAL | 6.615 | 8.545 | 8.200 | + improving |
