...
| Metric | GB | WAS | Delta |
|---|---:|---:|---:|
| Core EPA Offense | 0.091 | 0.052 | 0.039 |
| Core EPA Defense | 0.104 | 0.270 | -0.166 |
| Success Rate Offense | 0.465 | 0.500 | -0.035 |
| Success Rate Defense | 0.526 | 0.549 | -0.022 |
| Explosive Play Rate (Off) | 0.116 | 0.095 | 0.022 |
| Third Down Conversion | 0.214 | 0.300 | -0.086 |
| Points per Drive Differential | -0.455 | -1.889 | 1.434 |
| Yards per Play Differential | 0.498 | -0.740 | 1.238 |
...
| --- | ---: | ---: | ---: | ---: |
| EPA Offense | 35% | 0.001 | 0.131 | -0.130 |
| EPA Defense | 20% | -0.098 | 0.090 | -0.188 |
| Success Rate Offense | 25% | 39.3% | 46.7% | -7.4 pp |
| Tempo | 20% | 0.143 | 0.156 | -0.013 |

## PowerScore Breakdown (7 Metrics)

| Component | Weight | GB | WAS | Delta |
| --- | ---: | ---: | ---: | ---: |
| EPA Offense | 25% | 0.001 | 0.131 | -0.130 |
| EPA Defense | 20% | -0.098 | 0.090 | -0.188 |
| Success Rate Offense | 15% | 39.3% | 46.7% | -7.4 pp |
| Turnover Margin | 10% | 2.000 | 1.000 | +1.000 |
| Tempo | 10% | 0.143 | 0.156 | -0.013 |
| Red Zone TD Rate (Off) | 10% | 12.5% | 0.0% | +12.5 pp |
| Pressure Rate (Def) | 10% | 2.9% | 3.2% | -0.4 pp |

## PowerScore Summary

**Model (4 metrics):**
WAS edge: +0.104 (GB +0.108 vs WAS +0.212)
**7 metrics version:**
GB edge: +0.030 (GB +0.269 vs WAS +0.240)
**Verdict:** GB holds the edge in the extended breakdown (lead 0.030), driven by Turnover Margin (10% weight).
### Risk flags
...
| --- | ---: | ---: | ---: | ---: | ---: | --- |
| GB | 16.7% | 42.1% | -25.4% | 41.9% | 48.6% | Run heavy |
| WAS | 40.0% | 42.1% | -2.1% | 37.1% | 55.9% | Slight run lean |
...
| Team | Season-to-date | Last 5 | Last 3 |
| --- | ---: | ---: | ---: |
| GB | -16.3 pp | -16.3 pp | -16.3 pp |
| WAS | +18.0 pp | +18.0 pp | +18.0 pp |
...
| WAS | -1.6 pp | -1.6 pp | -1.6 pp |

### Explosive Plays

| Team | Season-to-date | Last 5 | Last 3 |
| --- | ---: | ---: | ---: |
| GB | -1.8 pp | -1.8 pp | -1.8 pp |
...
| WAS | -0.4 pp | -0.4 pp | -0.4 pp |

### Pass Success Edge

| Team | Season-to-date | Last 5 | Last 3 |
| --- | ---: | ---: | ---: |
| GB | -25.8 pp | -25.8 pp | -25.8 pp |
| WAS | -6.3 pp | -6.3 pp | -6.3 pp |
...
| Window | GB | WAS |
| --- | ---: | ---: |
| Season-to-date | 1.913 | 2.064 |
| Last 5 games | 1.913 | 2.064 |
| Last 3 games | 1.913 | 2.064 |
...
| ---: | --- | --- | --- | ---: | ---: | ---: | ---: |
| 1 | PHI (A) | 29-34 | PHI | 0.828 | 0.091 | 46.5% | -0.455 |

**WAS analogs vs GB profile**

| Week | Opponent | Score | Winner | Similarity | EPA Off | Success Rate | PPD Diff |
| ---: | --- | --- | --- | ---: | ---: | ---: | ---: |
| 1 | TB (A) | 20-37 | TB | 0.747 | 0.052 | 50.0% | -1.889 |

## Core EPA Offense Form (up to Week 1)

| Team | Season-to-date | Last 5 | Last 3 |
|------|---------------:|-------:|-------:|
| GB | 0.091 | 0.091 | 0.091 |
| WAS | 0.052 | 0.052 | 0.052 |

## Core EPA Defense Form (up to Week 1)

| Team | Season-to-date | Last 5 | Last 3 |
|------|---------------:|-------:|-------:|
| GB | 0.104 | 0.104 | 0.104 |
| WAS | 0.270 | 0.270 | 0.270 |
...
| Team | Season-to-date | Last 5 | Last 3 |
|------|---------------:|-------:|-------:|
| GB | -0.455 | -0.455 | -0.455 |
| WAS | -1.889 | -1.889 | -1.889 |

## Yards per Play Differential Form (up to Week 1)

| Team | Season-to-date | Last 5 | Last 3 |
|------|---------------:|-------:|-------:|
| GB | 0.498 | 0.498 | 0.498 |
| WAS | -0.740 | -0.740 | -0.740 |
...
| Team | Season-to-date | Last 5 | Last 3 |
|------|---------------:|-------:|-------:|
| GB | 7.818 | 7.818 | 7.818 |
| WAS | 8.222 | 8.222 | 8.222 |
